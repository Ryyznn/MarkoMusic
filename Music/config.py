...
# Client
SESSION_NAME = getenv('SESSION_NAME', 'BQBs9IKUI_BjKSXH1IBYUzlPEzzkkvCBctzq-DxssRpI6W3c6GyhcpWySgVRH6qetCrLB1hO8TO6gqxUB4tcxA0QiTM5X3dnCFtgIIoPIF_VqcZm4IS1mQFmj4a7TYuyGcc0lJdjknm65azxF7zzBjiwYhkrbKeB0KWfzXV-GcNeNA7BwT2v-nDZLDAPFxP7B8bIhTTnMHKFExrBs7yVxkPi6sfqRk33sch71uRhHBnKMKsomvlH8gR1kVwxbpVITNtVES_6G8nQBovin8wqkgB0H5GuODG7aZJTBxsj0-x8kW39TdSTAvvMeLeaaib2sTS7G8LD2THRbbMa1ZVtwPgPeb4-yAA')
API_ID = int(getenv('API_ID', '23184709'))
API_HASH = getenv('API_HASH', 'f99dd916ef41cf47ee094f771855468d')

# Bot
BOT_USERNAME = getenv("BOT_USERNAME", "ryznmusicbot")
BOT_TOKEN = getenv('BOT_TOKEN', '5524682825:AAF-R88Hx_AfetXZMg1_ykuz0Ti_psBOO6k')
...
# Database Mono
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://zennmusic:zennmusic@cluster0.jimla2w.mongodb.net/?retryWrites=true&w=majority")
...
# Log Chat
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001889413117"))
LOG_CHANNEL_ID = int(getenv("LOG_CHANNEL_ID", "-1001858010993"))
